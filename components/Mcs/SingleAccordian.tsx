...
const AccordionItem: React.FC<AccordionItemProps> = ({ item }) => {
  ...
  return (
    <div className={`accordion-item ${isOpen ? "open" : ""} w-full`} key={item.id}>
      <div
        className="accordion-header bg-white dark:bg-bg-color-dark hover:bg-primary hover:bg-opacity-80 hover:text-white dark:hover:bg-primary dark:hover:bg-opacity-80 dark:hover:text-white"
