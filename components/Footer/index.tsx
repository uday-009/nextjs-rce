        ...
        <div className="container">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="flex items-center">
                  <a
                    href="https://www.facebook.com/profile.php?id=100095364125059"
                  ...
                  <a
                    href="https://twitter.com/relatecentral"
                    aria-label="social-link"
                    className="mr-6 text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                  >
                    <svg
                  ...
                  <a
                    href="https://www.linkedin.com/company/relate-central-inc/"
                    aria-label="social-link"
              ...
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li>
                    ...
                    >
                      Request a Cyber Health Check
                    </a>
                  </li>
                  <li>
                    <a
                      href="https://relatecentral.com/cyber_central_blog/"
                      title="Cyber Central for Industry News &amp; Views"
                      className="mb-4 inline-block text-base text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                    >
                      Cyber Central for Industry News &amp; Views
                    </a>
                  </li>
                  {/* <li>
                    <a
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  ...
                  <li>
                    <a
                      href="https://relatecentral.com/privacy-policy/"
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  ...
                  <li>
                    <a
                      href="https://relatecentral.com/it-cybersecurity-resources/it-cybersecurity-jobs-architects-developers-engineers-analysts/"
                      title="Careers With Relate Central"
                      className="mb-4 inline-block text-base text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                    >
                      Careers
                    </a>
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              Copyright ©{new Date().getFullYear()} Relate Central
            </p>
          </div>
        </div>
