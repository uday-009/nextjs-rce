              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Expertise in Secure Development Practices" />
                    <List text="Tailored Solutions for Your Unique Needs" />
                    <List text="Comprehensive Security Testing" />
                  </div>

                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Commitment to Compliance and Regulations" />
                    <List text="End-to-End Security Solutions" />
                  </div>
                </div>
              </div>
            </div>
